...
- **Delegating (`claude-plus-agents`):** link the brief from the handoff's
  context list, alongside `guidance/toolchain-brief.md`.
- **Solo (`claude-only`):** open a new session, paste the brief, then the spec.
